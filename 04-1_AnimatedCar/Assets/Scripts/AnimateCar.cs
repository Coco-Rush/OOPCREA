...
public class AnimateCar : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        wheelIncrement = forwardInput * GetIncrementalValue(); //forwardMovement * (120 + GetIncrementalValue()) / wheelCircumference;
        wheelhorizontal = forwardInput * horizontalInput * 45;
        ...
        rightRearWheelTransform.localRotation = Quaternion.Euler(wheelIncrement, 0, 0);
        rightFrontWheelTransform.localRotation = Quaternion.Euler(wheelIncrement, wheelhorizontal, 0);
        leftRearWheelTransform.localRotation = Quaternion.Euler(wheelIncrement, 0, 0);
        leftFrontWheelTransform.localRotation = Quaternion.Euler(wheelIncrement, wheelhorizontal, 0);
